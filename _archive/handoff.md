...
3.  **Workspace Customization**:
    -   Created `.cursorrules` as the single source of truth for Antigravity & Claude.
    -   Enabled "Turbo Mode" rules for full autonomy.
    -   Archived obsolete "The Hierarchy of Rules.md".
