            ...
            <aside className="w-64 bg-gray-800 text-white hidden md:flex flex-col">
                ...
                <nav className="flex-1 px-4 space-y-6 mt-6 overflow-y-auto">
                    ...
                    <div className="space-y-1">
                        ...
                        <Link href="/dashboard/projects" className="flex items-center space-x-3 px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-lg transition-colors">
                            <HardHat className="h-4 w-4" />
                            <span className="text-sm">Projects</span>
                        </Link>
                        <Link href="/dashboard/map" className="flex items-center space-x-3 px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-lg transition-colors">
                    ...
                    <div className="space-y-1">
                        ...
                        <Link href="/dashboard/rod-pass" className="flex items-center space-x-3 px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-lg transition-colors">
                            ...
                            <span className="text-sm">Log Rod Pass</span>
                        </Link>
                        <Link href="/dashboard/qc" className="flex items-center space-x-3 px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-lg transition-colors">
                    ...
                    <div className="space-y-1">
                        ...
                        {session.user.role === "OWNER" && (
                            <>
                                ...
                                <Link href="/dashboard/settings" className="flex items-center space-x-3 px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white rounded-lg transition-colors">
